...
# Объекты имеют свойства, к catорым можно доступиться с помощью точки
print(my_car.color)
"Бордовый металлик"
print(my_car.price)
"1 000 000 руб"
...
# Объекты имеют действия, catорые с ними можно производить.
# Неcatорые свойства объектов могут менятся после действий над объектами
...
# использующийся для всех ссылок на атрибуты в Python: объект.name.
