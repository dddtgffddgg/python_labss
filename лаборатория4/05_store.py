...
# TODO здесь ваш код
for namegoods in goods:
    codegoods = goods[namegoods]
    price = 0
    quantity = 0
    for quantity_price in store[codegoods]:
        price = price + quantity_price['quantity'] * quantity_price['price']
        quantity += quantity_price['quantity']
    print(namegoods, '-', quantity, 'шт, общей стоимостью', price, 'рублей.')